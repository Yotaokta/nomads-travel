        ...
        <section class="section-popular-content" id="popularContent">
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    @forelse ($listOfTravel as $travel)
                        ...
                        <div class="card-travel text-center d-flex flex-column"
                            ...
                            <div class="travel-location">{{ $travel->title }}</div>
                            <div class="travel-button mt-auto">
                                <a href="{{ route('details', $travel->slug) }}" class="btn btn-travel-details px-4">
                                    View Details
                                </a>
                            </div>
                        </div>
                    ...
                    @empty
                    <p class="alert-danger">Travel Belum Tersedia</p>
                    @endforelse          
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="section-popular-travel row justify-content-center match-height">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="{{ url('/images/avatar-1.png') }}" alt="" class="mb-4 rounded-circle" />
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="{{ url('/images/avatar-2.png') }}" alt="" class="mb-4 rounded-circle" />
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content mb-auto">
                                <img src="{{ url('/images/avatar-3.png') }}" alt="" class="mb-4 rounded-circle" />
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{ url('/faq') }}" class="btn btn-need-help px-4 mt-4 mx-1">
                            I Need Help
                        </a>
